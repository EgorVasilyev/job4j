...
public class DinamicContainerLLTest {
    ...
    @Test
    public void whenAddThreeElementsAndDeleteThriceThenReturnTreeTwoOne() {
        linkedList = new DinamicContainerLL<>();
        linkedList.add(1);
        linkedList.add(2);
        linkedList.add(3);
        assertThat(linkedList.delete(), is(3));
        assertThat(linkedList.delete(), is(2));
        assertThat(linkedList.delete(), is(1));
    }
}